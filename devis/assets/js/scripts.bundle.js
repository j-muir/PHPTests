...
KTUtil.ready(function() {
    ...
    // Init Quick User Panel
    if (typeof KTLayoutQuickUserA !== 'undefined') {
        KTLayoutQuickUserA.init('kt_quick_user_a');
    }
...
var KTLayoutQuickUserA = function() {
    // Private properties
    var _element;
    var _offcanvasObject;
    ...
    var _init = function() {
        ...
        _offcanvasObject = new KTOffcanvas(_element, {
            ...
            baseClass: 'offcanvas',
            placement: 'right',
            closeBy: 'kt_quick_user_a_close',
            toggleBy: 'kt_quick_user_toggle_delatopbar'
        });
...
// Webpack support
if (typeof module !== 'undefined') {
    module.exports = KTLayoutQuickUserA;
}
