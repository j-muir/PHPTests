...
<head>
    <base href="../">
    <meta charset="utf-8"/>
    <title>VDMA | Validation des devis</title>
                        ...
                        <div class="card card-custom">
                            <div class="card-header flex-wrap py-5">
                                <div class="card-title">
                                    <h3 class="card-label">Validation d'un devis</h3>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row pt-4 pb-4">
                                    <div class="col-lg-2">
                                        <input type="text" class="form-control" id="rechercheDevis" placeholder="ID du devis recherché" />
                                    </div>
                                    <div class="col-lg-10">
                                        &nbsp;
                                    </div>
                                </div>
                                <div class="row resultatRecherche d-none">
                                    <div class="col-lg-12">
                                        <table class="table table-borderless">
                                            <tr>
                                                <td><b>N° fiche :</b> <span id="numero"></span></td>
                                                <td><b>Date de la demande :</b> <span id="datedemande"></span></td>
                                                <td colspan="2"><b>Reçu par :</b> <span id="recupar"></span></td>
                                            </tr>
                                            <tr>
                                                <td colspan="5"><b>Contact groupe :</b><br /><span id="contactgroupe"></span></td>
                                            </tr>
                                            <tr>
                                                <td><b>Date de la visite :</b> <span id="datevisite"></span></td>
                                                <td colspan="2"><b>Devis pour le :</b> <span id="devispourle"></span></td>
                                                <td colspan="2"><span id="museedevis"></span></td>
                                            </tr>
                                            <tr>
                                                <td colspan="5"><b>Participants :</b> <span id="participant"></span></td>
                                            </tr>
                                            <tr>
                                                <td colspan="5"><b>Prestations complémentaires :</b> <span id="prestationscomplementaires"></span></td>
                                            </tr>
                                        </table>
                                    </div>
                                    <div class="col-lg-12">
                                        <button class="w-100 btn btn-success valideDevis">Valider le devis</button>
                                    </div>
                                </div>
                                <div class="row erreurRecherche d-none">
                                    <div class="col-lg-12 alert alert-danger">
                                        Numéro de devis non trouvé
                                    </div>
                                </div>
                                <!--end: Datatable-->
                            </div>
...
<script src="assets/js/pages/fiches/mainvalidation.js"></script>
