...
$arrayCommandes = getCommandes($connexion, '1', $exerciceencours);
...
<head>
    <base href="../">
    <meta charset="utf-8"/>
    <title>VDMA | Gestion des devis annulées</title>
                        ...
                        <div class="card card-custom">
                            <div class="card-header flex-wrap">
                                <div class="card-title">
                                    <h3 class="card-label">Gestion des devis annulées</h3>
                                </div>
                                ...
                                <table class="table table-separate table-head-custom table-checkable" id="kt_datatable">
                                    ...
                                    foreach ($arrayCommandes as $keyA => $valA) {
                                        ...
                                        echo '<tr class="modCommande" data-id="' . $keyA . '">
                                            <td style="width:10%;">' . $valA['numero'] . '</td>                                            
                                            <td style="width:10%;">' . $valA['date'] . '</td>    
                                            <td>' . $valA['travauxaexecuter'] . '</td>      
                                            <td><b>' . $client . '</b></td>
                                            <td>' . $valA['commentaire'] . '</td>
                                            <td style="width:10%;">' . $valA['montantht'] . '</td>
                                        </tr>';
                                    }
...
<script src="assets/js/pages/modalecommande/main.js"></script>
<script src="assets/js/pages/commandesAnnulees/main.js"></script>
