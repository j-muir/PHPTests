...
<head>
    <base href="../">
    <meta charset="utf-8"/>
    <title>VDMA | Gestion des clients</title>
                        ...
                        <div class="card card-custom">
                            <div class="card-header flex-wrap py-5">
                                <div class="card-title">
                                    <h3 class="card-label">Gestion des clients/prospects</h3>
                                </div>
                                <div class="card-toolbar">
                                    <!--begin::Button-->
                                    <button id="addClients" type="button" class="btn btn-primary" data-keyboard="false">
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-separate table-head-custom table-checkable" id="kt_datatable">
                                    ...
                                    foreach ($arrayClients as $keyA => $valA) {
                                        $societeNP = $valA['nom'] . ' ' . $valA['prenom'];
                                        if (!empty($valA['societe'])) {
                                            $societeNP = $valA['societe'] . ' - ' . $valA['nom'] . ' ' . $valA['prenom'];
                                        }

                                        if (!empty($valA['numtel']) && !empty($valA['numportable'])) {
                                            $lesnumtel = $valA['numportable'] . '<br>' . $valA['numtel'];
                                        } else if (!empty($valA['numportable'])) {
                                            $lesnumtel = $valA['numportable'];
                                        } else {
                                            $lesnumtel = $valA['numtel'];
                                        }

                                        echo '<tr class="modClient" data-id="' . $keyA . '">
                                            <td><b>' . $societeNP . '</b></td>
                                            <td>' . $valA['adresse'] . '</td>
                                            <td>' . $valA['ville'] . '</td>
                                            <td>' . $valA['codepostal'] . '</td>
                                            <td>' . $lesnumtel . '</td>
                                        </tr>';
                                    }
...
<script src="assets/js/pages/clients/main.js"></script>
