...
$arrayGetExercices = getExercices($connexion);
...
<head>
    <base href="../">
    <meta charset="utf-8"/>
    <title>VDMA | Gestion des exercices</title>
...
<div class="d-flex flex-column flex-root">
    ...
    <div class="d-flex flex-row flex-column-fluid page">
        ...
        <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
                        ...
                        <div class="card card-custom">
                            <div class="card-header flex-wrap py-5">
                                <div class="card-title">
                                    <h3 class="card-label">Gestion des exercices</h3>
                                </div>
                                <div class="card-toolbar">
                                    <!--begin::Button-->
                                    <button id="addExercice" type="button" class="btn btn-primary" data-keyboard="false"
                                            data-toggle="modal" data-target="#staticBackdrop">Ajouter un exercice
                                    </button>
                                    <!--end::Button-->
                                </div>
                            </div>
                            <div class="card-body">
                                ...
                                <table class="table table-separate table-head-custom table-checkable" id="kt_datatable">
                                    ...
                                    <tbody>
                                    <?php
                                    foreach ($arrayGetExercices as $keyS => $valS) {
                                        echo '<tr class="modExercice" data-id="' . $keyS . '">
                                            <td>' . $valS['nom'] . '</td>
                                            <td>' . $valS['annee'] . '</td>
                                            <td class="changeExerciceActif" data-id="' . $keyS . '">' . $valS['actif'] . '</td>
                                        </tr>';
                                    }
                                    ?>
                                    </tbody>
                            ...
                            <div class="modal-body">
                                <div class="mb-5">
                                    <div class="form-group row">
                                        <div class="col-lg-12">
                                            <input id="nomexercice" type="text" class="form-control" placeholder="Nom"
                                                   name="nomexercice"/>
                                            <span class="form-text text-muted font-weight-bold">*Nom</span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-lg-6">
                                            <input class="form-control" name="annee" id="annee" type="number" min="2000"
                                                   max="2999" step="1" value="<?php echo date('Y'); ?>"/>
                                            <span class="form-text text-muted font-weight-bold">*Année de l'exercice</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal fade" id="modalChangeExercice" data-backdrop="static" tabindex="-1" role="dialog"
                 aria-labelledby="staticBackdrop" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="modalChangeExerciceTitle">Changement d'exercice</h5>
                            <button class="close" data-dismiss="modal" aria-label="Close">
                                <i aria-hidden="true" class="ki ki-close"></i>
                            </button>
                        </div>
                        <div class="modal-body">
                            <p>Vous allez changer l'exercice actif. <br><br> Êtes-vous sûr de vouloir continuer ?</p>
                        </div>
                        <div class="modal-footer">
                            <button class="btn btn-light-danger font-weight-bold" data-dismiss="modal">Annuler</button>
                            <button type="submit" id="saveModalChangeExercice" type="button"
                                    class="btn btn-primary font-weight-bold">Valider
                            </button>
                        </div>
                    </div>
                </div>
...
<script src="assets/js/pages/exercices/main.js"></script>
