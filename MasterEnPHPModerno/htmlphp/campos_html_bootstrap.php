        ...
        <h1>Campos de formulario html con php</h1>
            ...
            <form method="GET" action="recibe.php">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="nombre" value="<?php echo isset($nombreEnviado); ?>">           
                </div>
                <div class="form-group">
                ...
                <div class="form-group form-check">
                    <input type="checkbox" name="cocina" class="form-check-input">
                    <label class="form-check-label" for="cocina">Cocina</label>
                </div>
                <div class="form-group form-check">
                    <input type="checkbox" name="cine" class="form-check-input">
                    <label class="form-check-label" for="cine">Cine</label>
                </div>
                <div class="form-group form-check">
                    <input type="checkbox" name="lectura" class="form-check-input">
